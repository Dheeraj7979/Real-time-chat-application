...
const LeftSidebar = () => {
  ...
  return (
    <div className='w-full md:w-[30%] flex flex-col bg-white p-4 gap-4 relative'>
    
      {
        isSmall?<Navbar></Navbar>:<></>
      }
      ...
      {/* all chat boxes  */}
      <div className='flex-1 flex flex-col gap-1 overflow-scroll scrollbar-none'>
        <Chatboxes/>
        <Chatboxes/>
        <Chatboxes/>
        <Chatboxes/>
...
const Chatboxes = ()=>{
  return(
    <div className=' p-2 flex flex-row gap-3 relative'>
      ...
      <div className='absolute right-2 flex flex-col gap-1'>
        ...
        <div className='bg-green-400 rounded-full items-center text-center text-white'>12</div>
      </div>
    </div>
  )
}
